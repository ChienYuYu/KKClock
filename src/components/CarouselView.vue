<template>
  <div class="bg-white pb-5 pt-5">
    <div ref="carousel" id="carouselExampleCaptions" class="carousel slide carousel-fade container"
      data-bs-ride="carousel">
      <div class="carousel-inner rounded-3">
        <router-link to="product_list/全部商品" class="carousel-item active">
          <img src="../assets/img/banner04.jpg"
          class="banner d-block w-100" alt="banner1" height="400" />
        ...
        <router-link to="product_list/全部商品" class="carousel-item">
          ...
          class="banner d-block w-100" alt="banner2" height="400" />
          <div class="carousel-caption">
            <h5 class="mb-0 slogan rounded-3">
              kkClock<br />鐘的專家 最專業時鐘專賣<br />
            </h5>
        ...
        <router-link to="product_list/全部商品" class="carousel-item">
          ...
          class="banner d-block w-100" alt="banner3" height="400" />
          <div class="carousel-caption">
            <h5 class="mb-0 slogan rounded-3">
              kkClock<br />鐘的專家 最專業時鐘專賣<br />
            </h5>
